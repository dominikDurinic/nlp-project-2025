...
## Opis
Koristeći metode obrade prirodnog jezika (engl. NLP methods) istražiti članke i pripadne komentare u medijima, kao i objave te komentare na društvenim mrežama u svrhu klasifikacije i utvrđivanja osjećaja nostalgije ili kritike u tekstovima vezanim uz Jugoslaviju.
Također provesti analizu i vizualizaciju rezultata u svrhe određivanja zastupljenosti osjećaja nostalgije ili kritike prema bivšoj državi Jugoslaviji na području Republike Hrvatske.

Dodatna pitanja vezana uz tematiku: 
- Diskusije o načinu života, rada i djelovanja unutar Jugoslavije 
